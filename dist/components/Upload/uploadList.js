...
export var UploadList = function (props) {
    ...
    return (React.createElement("ul", { className: "ark-upload-list" }, fileList.map(function (item) {
        return (React.createElement("li", { className: "ark-upload-list-item", key: item.uid },
