...
export var Upload = function (props) {
    ...
    return (React.createElement("div", { className: "ark-upload-component" },
        React.createElement("div", { className: "ark-upload-input", style: { display: 'inline-block' }, onClick: handleClick },
            drag ? React.createElement(Dragger, { onFile: function (files) { uploadFiles(files); } }, children) : children,
            React.createElement("input", { className: "ark-file-input", type: "file", ref: fileInput, style: { display: 'none' }, accept: accept, multiple: multiple, onChange: handleFileChange })),
